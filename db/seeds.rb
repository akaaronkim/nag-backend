...
#Payment details
p12 = PaymentInfo.create(card_grid1: 4833, card_grid2: 1600, card_grid3: 3368, card_grid4: 2222, first_name: "aaron", last_name: "kim", expiration_date: "2022-12-31", cvv: 248, card_type: "visa", user:user1  )
...
p1 = PaymentInfo.create(card_grid1: 4242, card_grid2: 4242, card_grid3: 4242, card_grid4: 4242, first_name: "User", last_name: "User", expiration_date: "2022-12-31", cvv: 643, card_type: "visa", user:user1  )
